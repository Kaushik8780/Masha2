...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Mashadb_user:sAIeeT3PLC3V40M2@mashadb.crgwd3s.mongodb.net/?appName=Mashadb")   # IF Multiple Database Is False Then Fill Only This Database Url.
