...
API_ID = int(environ.get('API_ID', '26913607'))
API_HASH = environ.get('API_HASH', 'd837cb90d519074b51f1777b3777d554')
BOT_TOKEN = environ.get('BOT_TOKEN', "8322381313:AAEpfGD0R3i89U0FmJCd8gPeU7QqhTQv8_Q")


# This Pictures Is For Start Message Picture, You Can Add Multiple By Giving One Space Between Each.
PICS = (environ.get('PICS', 'https://graph.org/file/1144a42319a7005c64f99-7bd37148280d4974a3.jpg https://graph.org/file/a873e6aac2ac915b67e70-413b5c7ba53bb8d02f.jpg')).split()


# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5738170624').split()] # For Multiple Id Use One Space Between Each.
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002140022179'))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1003070341496').split()]  # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('AUTH_CHANNEL', '-1004294234778') # give your force subscribe channel id here else leave it blank
...
support_chat_id = environ.get('SUPPORT_CHAT_ID','-1003963294060')
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://mashadb_usermashadb@2955pass@mashadb.w1bfeqr.mongodb.net/?appName=Mashadb")   # IF Multiple Database Is False Then Fill Only This Database Url.
DATABASE_NAME = environ.get('DATABASE_NAME', "Mashadb")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'SKcollection')
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+zOKfJgE4A9QzNzA1')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/AZ_ADDA_HUB')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'AZ_MOVIES_SUPPORT') # Support Chat Link Without https:// or @
OWNER_LNK = environ.get('OWNER_LNK', 't.me/Solanki2955')
...
SHORTLINK_API = environ.get('SHORTLINK_API', '2ca82f8267f7c6f99fc57435e4530706ccf88050')
