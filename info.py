...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://masha_db_user:TqLGOdsYU4eCB4DB@mashadb.rq05mne.mongodb.net/?appName=Mashadb")   # IF Multiple Database Is False Then Fill Only This Database Url.
