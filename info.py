...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://masha_db_user:<db_password>@cluster0.cgl0nkn.mongodb.net/?appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
